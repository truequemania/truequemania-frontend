...
import { handleDelete } from "../../validation/category/handleDelete";
import { handleGet } from "../../validation/category/handleGet";

function CategoriaTable({ toggleModalAct }: { toggleModalAct: () => void }) {
